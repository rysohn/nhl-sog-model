...
get_daily_game_reports <- function(date) {
  ...
  games <- rbind(df, df2)
  games[c('l8_sa', 'l8_sog', 'l8_miss', 'l8_blocks', 'l4_sa', 'l4_sog', 'l4_miss', 'l4_blocks', 'ha_sa', 
          'ha_sog', 'ha_miss', 'ha_blocks', 'l8_sa_ag', 'l8_sog_ag', 'l8_miss_ag', 'l8_blocks_ag',
          'l4_sa_ag', 'l4_sog_ag', 'l4_miss_ag', 'l4_blocks_ag', 'ha_sa_ag', 'ha_sog_ag', 
          'ha_miss_ag', 'ha_blocks_ag', 'is_b2b', 'opp_is_b2b', 'true_sog')] <- NA
  #return(games)
  temp4 <- 0
...
# train_data_25 - 2025-11-01 - 2025-12-31
...
daily_report_red <- daily_reports %>% 
  dplyr::select(c('game_id', 'team', 'opponent', 'l8_sog', 'sog_trend', 'l8_sog_ag', 'sog_ag_trend', 'is_b2b', 'opp_is_b2b', 'shot_perc', 'shot_perc_ag', 'home', 'pred_sog'))
daily_report_red
